...
<head>
    ...
    <title>Nouveau mot de passe - FESPACO</title>
...
<body>
    ...
    <div class="shell">
        <section class="left">
            ...
            <span class="tag">Securite compte</span>
            <h1>Definir un nouveau mot de passe</h1>
            <p class="lead">
                Choisissez un nouveau mot de passe robuste pour securiser votre compte et reprendre l'acces a votre espace.
            </p>
        </section>
        ...
        <section class="right">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <button type="submit" class="submit">Valider le nouveau mot de passe</button>
            </form>
