...
<body>
    ...
    <div class="shell">
        <section class="left">
            ...
            <span class="tag">Portail officiel</span>
            <h1>Connexion a votre espace festival</h1>
            <p class="lead">
                Connectez-vous pour acceder aux contenus reserves, poursuivre votre visionnage et gerer votre profil.
            </p>
        </section>
        ...
        <section class="right">
            ...
            @if(Route::has('register'))
                <p class="bottom">
                    ...
                    <a class="link" href="{{ route('register') }}">Creer un compte</a>
                </p>
            @endif
        </section>
    </div>
