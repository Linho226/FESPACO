...
<head>
    ...
    <title>Inscription - FESPACO</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .submit:hover {
            ...
            box-shadow: 0 8px 18px rgba(247, 179, 43, 0.28);
        }
        ...
        .admin-opt input { accent-color: var(--accent); }
...
<body>
    ...
    <div class="shell">
        <section class="left">
            ...
            <span class="tag">Espace membre</span>
            <h1>Creez votre compte festival</h1>
            <p class="lead">
                Inscrivez-vous pour suivre les projections, acceder aux contenus reserves et personnaliser votre experience.
            </p>
        </section>
        ...
        <section class="right">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                @if(!empty($canCreateAdmin) && $canCreateAdmin)
                    <div class="admin-opt">
                        <label for="create_admin">
                            <input id="create_admin" type="checkbox" name="create_admin" value="1" {{ old('create_admin') ? 'checked' : '' }}>
                            Creer ce compte en tant qu'administrateur
                        </label>
                        <div class="admin-hint">
                            Cette option n'est disponible qu'une seule fois, tant qu'aucun compte admin n'existe dans la base.
                        </div>
                    </div>
                @endif
            ...
            <p class="bottom">
                ...
                <a class="link" href="{{ route('login') }}">Se connecter</a>
            </p>
        </section>
    </div>
    </div>
