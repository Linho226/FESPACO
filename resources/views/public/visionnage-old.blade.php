    ...
    <div class="card player-card">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
                <div>
                    <h2 class="mb-1">{{ $projection->getTitreAffiche() }}</h2>
                </div>
            ...
            @if($activeMedia)
                ...
                <div class="mt-3">
                    ...
                    @if(!empty($activeMedia['fichier_url']) || !empty($activeMedia['embed_url']))
                        <button id="enable-sound-btn" type="button" class="btn btn-sm btn-outline-primary mt-2">Activer le son</button>
                        <small id="sound-help" class="text-muted d-block mt-1"></small>
                    @endif
...
<script>
    ...
    function enableEmbedSound() {
        ...
        try {
            ...
            console.warn('Activation du son impossible pour ce lecteur', e);
        }
    ...
    enableSoundBtn?.addEventListener('click', () => {
        if (html5Video) {
            ...
            enableSoundBtn.textContent = 'Son active';
        ...
        if (soundHelp) {
            soundHelp.textContent = 'Impossible d activer le son automatiquement pour cette source.';
        }
    });
