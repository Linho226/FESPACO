...
@section('title', $acteur->prenom . ' ' . $acteur->nom . ' - Acteur')
...
<div class="container py-5">
    <div class="modern-card shadow-lg border-0 mb-4 p-4">
        <div class="d-flex flex-wrap align-items-center mb-4" style="gap: 2.5rem;">
            @if($acteur->photo)
                <span class="modern-photo" style="margin-bottom:0;">
                    <img src="{{ asset('storage/' . $acteur->photo) }}" alt="Photo de l'acteur" class="img-fluid">
                </span>
            @endif
            <div>
                <h1 class="display-5 fw-bold mb-2 modern-title">{{ $acteur->nom }} {{ $acteur->prenom }}</h1>
                <h5 class="modern-subtitle">Acteur</h5>
                <div class="mb-2">
        ...
        <div class="mt-2">
            ...
            <div class="modern-bio">{{ $acteur->biographie }}</div>
        </div>
    </div>
</div>
@endsection
